                    ...
                    {fotosPreview.map((url, i) => (
                      <div key={i} className="w-24 h-24 rounded-2xl bg-surface border border-surface-border relative overflow-hidden group">
                        ...
                        <div className="absolute inset-0 bg-black/40 flex flex-row items-center justify-center gap-2 opacity-100 lg:opacity-0 group-hover:opacity-100 transition-opacity">
                          <button onClick={(e) => { e.preventDefault(); setImagenAmpliada(url); }} className="bg-blue-500 text-white p-1.5 rounded-full hover:scale-110 transition-transform shadow-sm" title="Ampliar">
                            <ZoomIn className="w-4 h-4" />
                          </button>
                          <button onClick={(e) => { e.preventDefault(); handleEditCrop(i); }} className="bg-brand-primary text-white p-1.5 rounded-full hover:scale-110 transition-transform shadow-sm" title="Editar recorte">
                            <Edit className="w-4 h-4" />
                          </button>
                          <button onClick={(e) => { e.preventDefault(); eliminarFotoPreview(i); }} className="bg-red-500 text-white p-1.5 rounded-full hover:scale-110 transition-transform shadow-sm" title="Eliminar">
                            <Trash2 className="w-4 h-4" />
                          </button>
                        </div>
                      </div>
