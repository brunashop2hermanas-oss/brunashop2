    ...
    return (
      <div className="flex-1 p-6 md:p-10 space-y-6 max-w-7xl mx-auto w-full">
        <div className="flex justify-between items-center mb-8">
          <div className="h-8 w-64 bg-surface-border/50 animate-pulse rounded"></div>
          <div className="h-10 w-32 bg-surface-border/50 animate-pulse rounded-full"></div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6].map(i => (
            <div key={i} className="bg-surface rounded-3xl p-6 border border-surface-border space-y-4">
              <div className="flex justify-between">
                <div className="h-5 w-24 bg-surface-border/50 animate-pulse rounded"></div>
                <div className="h-5 w-16 bg-surface-border/50 animate-pulse rounded"></div>
              </div>
              <div className="h-6 w-3/4 bg-surface-border/50 animate-pulse rounded"></div>
              <div className="h-4 w-1/2 bg-surface-border/50 animate-pulse rounded"></div>
              <div className="h-20 w-full bg-surface-border/50 animate-pulse rounded-xl mt-4"></div>
            </div>
          ))}
        </div>
      </div>
              ...
              {pedidosARenderizar.length === 0 ? (
                ...
                return (
                  <tr key={pedido.id} className="hover:bg-white/5 transition-colors">
                      ...
                      {(() => {
                        ...
                        return (
                          <button
                            ...
                            className={`px-3 py-2 rounded-lg font-bold text-xs transition-colors flex flex-col items-center justify-center w-full gap-1 border shadow-sm ${esTiendaDirecta
                    ...
                    <td className="px-2 py-3">
                      <span className={`px-3 py-1 rounded-full text-xs font-bold ${pedido.estado === 'Pendiente' ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/50' :
                  ...
                  {(() => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full px-3 py-2 rounded-lg font-bold text-xs transition-colors flex items-center justify-center gap-2 shadow-md ${esTiendaDirecta
                            ? 'bg-blue-500/10 text-blue-600 border-blue-500/30 cursor-default'
                            : todasEmpaquetadas
                  ...
                  return (
                    <div key={art.id} className={`flex items-center justify-between p-4 rounded-2xl border transition-colors ${art.empaquetado ? 'bg-green-500/10 border-green-500/30' : 'bg-background border-surface-border'}`}>
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl font-bold text-sm transition-all shadow-md flex items-center gap-2 ${art.empaquetado
